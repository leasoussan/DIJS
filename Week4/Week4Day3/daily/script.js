...
function getCarHonda(carInventory){
    const searchHonda = carInventory.find((element) => element.car_make ==="honda");
    return `this is a ${searchHonda.car_make} ${searchHonda.car_model} from ${searchHonda.car_year}`;
}

const carDisplay = getCarHonda(inventory);
...
// }
// we are sorting here with substracting the a, with b to get the difference and to know if its biger than 0 or smaller
// his will allowes to know the order 
